...
def id_name():
    save_path = "id_name.csv"
    workbook = xlrd.open_workbook('id_names.xls')
    booksheet = workbook.sheet_by_index(0)
    result = {}
...
def pandasReadxls(result):
    ...
    for sheet in sheets:
        ...
        print len(name_point1_list), len(name_point2_list)
        print sheet
        name1_list = []
        name2_list = []
